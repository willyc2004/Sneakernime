				...
				<div class="card-body">
					...
					<div class="bg-light rounded p-3 d-none d-lg-block">
						<div class="row row-cols-6 justify-content-between g-4">
							<div class="col"><h6 class="mb-0">Nama</h6></div>
                            ...
                            <div class="col"><h6 class="mb-0">Shipping Status</h6></div>
					...
					<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-6 g-2 g-sm-4 align-items-md-center justify-content-between border-bottom px-2 py-4">
						...
						<div class="col">
							<div class="d-flex align-items-center">
								...
								<!-- Title -->
								<u><h6 class="mb-0 ms-2"><a href="/adminproductdetails">Full Background</h6></a></u>
							</div>
						</div>
