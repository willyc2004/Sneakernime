            ...
            <div class="col-lg-8 ms-auto">
                <div class="row g-4">
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <ul class="nav flex-column text-primary-hover">
                            <li class="nav-item"><a class="nav-link text-body-secondary"
                                    href="https://shopee.co.id/sneakernime" target="_blank">Shopee</a></li>
                ...
                <div class="d-lg-flex justify-content-between align-items-center py-3 text-center text-lg-start">
                    ...
                    <div class="nav mt-2 mt-lg-0">
                        <ul class="list-inline text-primary-hover mx-auto mb-0">
                            <li class="list-inline-item me-0"><a class="nav-link text-body-secondary py-1">Made</a>
                            </li>
                            <li class="list-inline-item me-0"><a class="nav-link text-body-secondary py-1">With</a>
                            </li>
                            <li class="list-inline-item me-0"><a
                                    class="nav-link text-body-secondary py-1 pe-0">Love</a></li>
                        </ul>
                    </div>
                </div>
            </div>
